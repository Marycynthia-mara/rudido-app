                ...
                <div className="lg:float-left w:full lg:w-3/12 min-h-36 py-4">
                  <div className="w-full min-h-36 shadow-all rounded-md px-4 py-6">
                    <div className="w-full min-h-16 mb-2">
                      <p>
                        Topic :{' '}
                        <span className="font-normal">Content Creation</span>
                      </p>
                      <p>
                        File Type : <span className="font-normal">Audio</span>
                      </p>
                    </div>

                    <Link
                      to="/"
                      className="block rounded-md shadow-all mb-2 text-center p-2 bg-darkBlue-100 text-white mb-2"
                    >
                      {' '}
                      view now
                    </Link>
                    ...
                    <Link
                      to="/"
                      className="block rounded-md shadow-all mb-2 text-center p-2 text-darkBlue-100"
                    >
                      {' '}
                      view Later
                    </Link>
                  ...
                  <div className="w-full min-h-36 shadow-all rounded-md py-4 mt-6">
                    <div className="w-full min-h-16 p-2">
                      ...
                      <Link
                        to="/"
                        className="block text-center rounded-all shadow-md p-2 text-darkBlue-100 mb-2"
                      >
                        {' '}
                        Pitch desk
                      </Link>
                ...
                <div className="lg:float-left hidden lg:block w-6/12 min-h-36 lg:p-4">
                  <div className="w-full rounded-md shadow-all p-4">
                    <div className="w-full min-h-36">
                      ...
                      <p>
                        Sector : <span className="font-normal">Creativity</span>
                      </p>
                      <p>
                        Skills :{' '}
                        <span className="font-normal">CreativArt, Design</span>
                      </p>
                      <p>
                        Content Topic :{' '}
                        <span className="font-normal">Creativity Writing</span>
                      </p>
                    </div>
                ...
                <div className="lg:float-left hidden lg:block w-3/12 min-h-36 py-4">
                  <div className="w-full min-h-36 shadow-all rounded-md px-4 py-6 mb-6">
                    <div className="w-full min-h-16 mb-2">
                      <p>
                        Venture Name :{' '}
                        <span className="font-normal">Edutech Lab</span>
                      </p>
                      <p>
                        Bio :{' '}
                        <span className="font-normal">
                          Helping Writers Launch and excel within Africa
                        </span>
                      </p>
                    </div>
                    ...
                    <Link
                      to="/"
                      className="block rounded-md shadow-all mb-2 text-center p-2 text-darkBlue-100 mb-2"
                    >
                      {' '}
                      Message
                    </Link>
