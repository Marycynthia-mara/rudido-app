                                        ...
                                        <div className="w-full min-h-32 py-4 xl:py-2 text-xxs">
                                            ...
                                            <div className="xl:flex xl:gap-2 w-full min-h-36">
                                                <div className="xl:flex-1">
                                                    <p className="text-pinkRose-200 text-xs py-4 px-2">My Portfolios</p>
                                                        ...
                                                        <div className="w-full min-h-8">
                                                            ...
                                                            <div className="w-7/12 xl:w-8/12 float-right min-h-8">
                                                                <div className="text-gray-500 float-right">
                                                                    ...
                                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 pr-1 inline pl-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z" />
                                                                    </svg>
                                
                                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 pr-1 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                ...
                                                <div className="xl:flex-1">
                                                    <p className="text-darkBlue-100 text-xs py-4 px-2">Others</p>
                                    ...
                                    <div className="hidden lg:block lg:w-4/12 xl:w-3/12 py-3 px-1 min-h-32 shadow-all rounded-15">
                                        ...
                                        <div className="w-full my-2 min-h-20">
                                            ...
                                            <div className="w-2/12 float-left text-pinkRose-200 pt-4 align-center">
                                                ...
                                                <img className="inline-block mb-2 h-6 md:w-6 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1491528323818-fdd1faba62cc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" />

                                                <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 m-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                                </svg>
                                            </div>
                                            ...
                                            <div className="w-9/12 float-right py-1 px-2 mb-2 shadow-all rounded-md border-tr-rounded-15">
                                                ...
                                                <p className="text-xxs text-pinkRose-200 truncate">Title : Africa Fishing report</p>
                                                <p className="text-xxs text-gray-500 truncate">Created 11 Feb 2021</p>
                                        ...
                                        <div className="w-full my-4 min-h-24">
                                            ...
                                            <div className="w-10/12 float-right p-2 mb-2 shadow-all rounded-md">
                                                ...
                                                <p className="text-xxs text-gray-500">Created 11 Feb 2021</p>
                                                <p className="text-xxs text-gray-500">Attend the seminar...</p>
