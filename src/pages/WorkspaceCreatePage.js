                        ...
                        <div className="flex-1 w-full min-h-1/4 mt-8">
                            <div className="w-full min-h-36">
                                <div className="flex flex-wrap lg:flex-no-wrap gap-4 lg:gap-8 text-darkBlue-100 mb-4">
                                    <a href="/" className="flex-1 rounded-15 shadow-all text-center p-2 active_tab">
                                        Overview
                                    </a>

                                    <a href="/" className="flex-1 rounded-15 shadow-all text-center p-2 ">
                                        Media
                                    </a>
                                ...
                                <div className=" hidden lg:block lg:float-left w:full lg:w-2/12 min-h-12 py-2">
                                    ...
                                    <div className="w-full min-h-12 shadow-all rounded-md px-2 py-2 text-xxs text-darkBlue-100 mb-6">
                                        ...
                                        <a href="/" className="block rounded-md shadow-all mb-2 p-2 bg-gray-300 mb-2">
                                            summary
                                        </a>
                                ...
                                <div className="lg:float-left w:full lg:w-8/12 min-h-36 lg:p-4">
                                    ...
                                    <div className="w-full rounded-md shadow-all p-4">
                                        <div className="w-full min-h-24">
                                            <p>Name : Dreamer</p>
                                            <p>Created : <span className="font-normal">28 February 2021 6:16 PM</span></p>
                                            <p>Stage : <span className="font-normal">1</span></p>
                                            <p>Type : <span className="font-normal">Text & Video</span></p>
                                        </div>

                                        <div className="w-full min-h-36 my-2">
                                            
                                            <div className="gap-2 mb-2">
                                                <div className="w-full min-h-36 shadow-all rounded-md my-4">
                                                ...
                                                <div className="w-full min-h-36 my-4 p-4">
                                                    ...
                                                    <div className="w-full my-2 min-h-12 text-darkBlue-100 mb-8">
                                                        ...
                                                        <div className="w-11/12 float-right px-2 mb-4">
                                                            ...
                                                            <p className="text-xs">Oppurtunity update <span className="inline-block float-right text-xxs">20 June 2021</span></p>
                                                            <p className="text-xs font-normal">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Laborum debitis eius!</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="w-full my-2 min-h-12 text-darkBlue-100 mb-8">
                                                        ...
                                                        <div className="w-11/12 float-right px-2 mb-4">
                                                            <p className="text-sm">Jane</p>
                                                            <p className="text-xs">Team update <span className="inline-block float-right text-xxs">20 June 2021</span></p>
                                                            <p className="text-xs font-normal">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Laborum debitis eius! Lorem ipsum dolor sit amet consectetur, adipisicing elit</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
