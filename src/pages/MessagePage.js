                        ...
                        <div className="flex-1 w-full min-h-1/4 mt-8">
                            <div className="w-full float-right lg:pl-4 min-h-32">
                                ...
                                <div className="flex flex-wrap lg:flex-no-wrap gap-1 md:gap-2 lg:gap-4 xl:gap-6 w-full mb-4 text-darkBlue-100 text-center">
                                    ...
                                    <Link to="/" className="py-2 px-2 lg:px-4 flex-1 float-right md:w-full rounded-15 shadow-md text-600"> Teams</Link>

                                    <Link to="/" className="py-2 px-2 lg:px-4 flex-1 float-right md:w-full rounded-15 shadow-md text-600"> Innovators</Link>

                                    <Link to="/" className="py-2 px-2 lg:px-4 flex-1 float-right md:w-full rounded-15 shadow-md text-600"> Hires</Link>

                                    <Link to="/" className="py-2 px-2 lg:px-4 flex-1 float-right md:w-full rounded-15 shadow-md text-600"> Reports</Link>
                                ...
                                <div className="flex flex-wrap lg:flex-no-wrap gap-1 md:gap-2 lg:gap-4 xl:gap-6 w-full mb-4 text-darkBlue-100 text-center">
                                    ...
                                    <div className="w-full lg:flex-1 my-2 min-h-16">
                                        ...
                                        <div className="w-2/12 h-6 float-left text-pinkRose-200 align-center mb-4">
                                            ...
                                            <img className="inline-block h-10 w-10 rounded-full ring-2 ring-white float-left" src="https://images.unsplash.com/photo-1491528323818-fdd1faba62cc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" />
                                        
                                        </div>

                                        <div className="w-10/12 float-left text-left px-2 mb-4">
                                            <p className="text-sm mb-2">Jane Okonkwo</p>
                                            <p className="w-36 bg-darkBlue-100 text-white py-1 px-2 rounded-sm shadow-md font-normal text-xs">Badge : Level 1

                                                <svg width="15" height="17" viewBox="0 0 19 21" className="ml-2 fill-current inline" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="w-full min-h-32 lg:flex lg:gap-4">
                                        ...
                                        <div className="w-full min-h-36 text-darkBlue-100 text-xxs">
                                            <div className="w-full p-3 shadow-all rounded-md min-h-12 mb-4 bg-white">
                                                <div className="w-full h-10">
                                                    ...
                                                    <div className="w-10/12 xl:w-11/12 float-right">
                                                        <div className="">
                                                            <p className="mb-1 text-xs truncate">Pauline williams
                                                            ...
                                                            <p className="text-gray-500 truncate">Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
                                                        </div>                                                
                                                    </div>  
                                                </div>
                                            </div>
                                            ...
                                            <div className="w-full p-3 shadow-all rounded-md min-h-12 mb-4 bg-white active_col_msg">
                                                <div className="w-full h-10">
                                                    ...
                                                    <div className="w-10/12 xl:w-11/12 float-right">
                                                        <div className="">
                                                            <p className="mb-1 text-xs truncate">James Hook
                                    ...
                                    <div className="hidden lg:block lg:flex-1 max-h-160 overflow-y-scroll rounded-md text-darkBlue-100 relative" style={chatBgd}>
                                        ...
                                        <div className="w-full p-3 min-h-12 mb-4 bg-darkBlue-100">
                                            <div className="w-full h-10">
                                                ...
                                                <div className="w-10/12 xl:w-11/12 float-right">
                                                    <div className="xl:pl-2">
                                                        <p className="mb-1 text-sm text-white truncate">James Hook  
                                                        </p>
                                                        
                                                        <p className="text-gray-500 text-xxs truncate text-pinkRose-200">Online</p>
                                                    </div>                                                
                                                </div>  
                                            </div>
                                        </div>
                                        ...
                                        <div className="w-full min-h-16 p-4">
                                            <div className="w-10/12 float-left min-h-12 text-xs text-gray-500 rounded-br-md rounded-bl-md bg-white p-3 mb-8">
                                                <p className="w-full">
                                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis ea similique repellendus maiores, totam facilis, omnis ipsam eum vitae explicabo, veritatis nobis culpa? Quos omnis maxime id obcaecati sequi pariatur
                                                </p>
                                        ...
                                        <div className="w-full min-h-16 p-4">
                                            <div className="w-10/12 float-right min-h-12 text-xs text-gray-500 rounded-br-md rounded-bl-md bg-white p-3  mb-8">
                                                <p className="w-full">
                                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis ea similique repellendus
                                                </p>
                                        ...
                                        <div className="w-10/12 p-2 min-h-10 absolute bottom-0 left-0 rounded-bl-md float-left">
                                            ...
                                            <textarea className="outline-none w-full rounded-15 p-2" name="" id="" cols="1"></textarea>
