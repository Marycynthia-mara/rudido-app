          ...
          <div className="relative w-full h-screen md:h-full overflow-y-scroll">
            ...
            <div className="max-h-screen absolute top-44 md:top-32 left-0 w-full mr-4 px-8 md:px-12 lg:px-20 pt-4">
              ...
              <div className="text-center">
                ...
                <span className="block text-md w-3/4 mx-auto text-gray-600 pb-8">
              ...
              <a
                ...
                className="rounded-30 block text-white py-2 px-4 mb-10 transition duration-200 bg-google-100 hover:bg-darkBlue-100 text-center"
              >
                {/* <?xml version="1.0"?> */}
                <svg
              ...
              <a
                ...
                className="rounded-30 block text-white py-2 px-4 mb-10 transition duration-200 bg-facebook-100 hover:bg-darkBlue-100 text-center"
              >
                <svg
                  className="h-6 w-6 inline"
                  fill="currentColor"
              ...
              <p className="text-gray-600 text-center pt-2">
                {' '}
                Don't have google or facebook account Signup
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              >
                ...
                <div className="flex flex-wrap">
                  ...
                  >
                    {userData.loading && userData.type === 'register' ? (
                      userData.message
                    ) : (
                      <>
                        <svg
