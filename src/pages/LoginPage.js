                ...
                <div className="md:flex-1 w-full md:w-3/5">
                    ...
                    <div className="relative w-full h-screen md:h-full overflow-y-scroll">
                        ...
                        <div className="absolute top-72 md:top-36 left-0 w-full mr-4 px-8 md:px-12 lg:px-20 pt-4">
                            ...
                            <a href="{{ url('auth/google') }}" className="rounded-30 block text-white py-2 px-4 mb-8 transition duration-200 bg-google-100 hover:bg-darkBlue-100 text-center">
                            ...
                            <a href="{{ url('auth/facebook') }}" className="rounded-30 block text-white py-2 px-4 mb-8 transition duration-200 bg-facebook-100 hover:bg-darkBlue-100 text-center">
                            ...
                            <form className="w-full space-y-6 sm:space-y-8" method="POST" action="{{ route('login') }}">
                                {/* @csrf */}
                                ...
                                <div className="flex flex-wrap">
                                    ...
                                    <input id="email" type="email"
                                        className="form-input w-full @error('email') border" name="email"
                                        value=""
                                ...
                                <div className="flex flex-wrap">
                                    ...
                                    <input id="password" type="password"
                                        className="form-input w-full @error('password') border" name="password"
                                        required />
                                ...
                                <div className="flex items-center">
                                    <label className="inline-flex items-center text-sm text-gray-700" for="remember">
                                    ...
                                    <a className="text-sm text-blue-500 hover:text-blue-700 whitespace-no-wrap no-underline hover:underline ml-auto"
                                ...
                                <div className="flex flex-wrap pt-2">
                                    ...
                                    <p className="w-full text-center text-gray-600 mt-4 mb-12 sm:text-sm sm:mb-4 sm:mt-4">
                                        ...
                                        <Link to="/register" className="text-red-500 hover:text-red-700 no-underline hover:underline">  Sign Up</Link>
                                    </p>
