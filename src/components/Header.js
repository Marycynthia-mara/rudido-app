...
function Header(props) {
  ...
  const action_btn_classes = `${
    header.profile_sec ? 'flex-1' : 'w-52 float-right'
        ...
        <div className="lg:flex-1">
          <div className="flex-1 text-white bg-darkBlue-100 rounded-30 px-4 w-4/5">
            ...
            <input
              type="text"
              placeholder="Search"
              className="placeholder-white px-4 py-2 bg-darkBlue-100 focus:outline-none w-4/5"
            />
          </div>
          ...
          {header.greeting_sec ? (
            <div>
              ...
              {header.greeting_mid_txt ? <p>{header.greeting_mid_cont}</p> : ''}
              ...
              <p>
                ...
                >
                  ...
                  <defs>
                    ...
                    >
                      <stop stopColor="#F04B92" />
                      <stop offset="1" stopColor="#F04B92" stopOpacity="0.7" />
                    </linearGradient>
                  </defs>
                </svg>
          ...
          <figure className="flex ">
            {header.profile_sec ? (
              <div className="flex-auto self-end mr-4">
                <img
                  className="float-right w-20 h-20 md:w-28 md:h-28 rounded-fullSide border-4 md:border-8 border-darkBlue-100"
              ...
              {header.action_btn ? (
                <Link className="pr-4 cursor-pointer" to={header.action}>
                  <div className={action_btn_classes}>
                    ...
                    >
                      <path
                        d="M18 2H10L8 0H2C0.9 0 0 0.9 0 2V14C0 15.1 0.9 16 2 16H18C19.1 16 20 15.1 20 14V4C20 2.9 19.1 2 18 2ZM15.94 13L13 11.28L10.06 13L10.84 9.67L8.25 7.43L11.66 7.14L13 4L14.34 7.14L17.75 7.43L15.16 9.67L15.94 13Z"
                        fill="url(#paint0_linear_1531_131)"
                      />
                      <defs>
                        <linearGradient
                          id="paint0_linear_1531_131"
                          x1="5.8"
                          y1="1.6"
                          x2="8.81044"
                          y2="16.325"
