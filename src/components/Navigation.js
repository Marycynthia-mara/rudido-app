    ...
    return (
        <>
            ...
            <div className="text-white flex justify-between px-8 pt-4 md:hidden">
                ...
                <Link exact to="/" className={`block p-4 content-center`}>
                    <span className="relative inline-flex rounded-full h-6 w-6 bg-pinkRose-200 stroke-white">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 absolute top-0.5 left-0.5 inline-flex" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="sidebar z-20 rounded-tl-30 rounded-bl-30 bg-darkBlue-100 text-blue-100 w-64 py-7 px-6 md:pt-12 overflow-y-scroll md:overflow-visible shadow-md md:rounded-30 absolute inset-y-0 md:ml-3 md:mb-14 md:mt-28 transform translate-hide md:relative md:translate-x-0 transition duration-200 ease-in-out">
                ...
                {/* <!-- logo --> */}
                <Link exact to="/" className={`block w-16 h-16 relative left-[-3%] md:w-28 md:h-28 md:absolute md:top-[-11%] md:left-10`}>
                ...
                <nav>
                    ...
                    <NavLink exact to="/" activeClassName="active" className={`nav-btn`}>
                        ...
                        <svg className="h-6 w-6 inline fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" >
                            <path d="M14.2222 1.93745V3.71522H10.6667V1.93745H14.2222ZM5.33333 1.93745V7.27078H1.77778V1.93745H5.33333ZM14.2222 9.04856V14.3819H10.6667V9.04856H14.2222ZM5.33333 12.6041V14.3819H1.77778V12.6041H5.33333ZM16 0.159668H8.88889V5.493H16V0.159668ZM7.11111 0.159668H0V9.04856H7.11111V0.159668ZM16 7.27078H8.88889V16.1597H16V7.27078ZM7.11111 10.8263H0V16.1597H7.11111V10.8263Z" fill="white"/>
                        </svg>
                    ...
                    <NavLink to="/marketplace" activeClassName="active" className={`nav-btn`}>

                        <svg width="18" height="15" className="inline" viewBox="0 0 18 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M17 0H1V1.83333H17V0ZM18 9.16667V7.33333L17 2.75H1L0 7.33333V9.16667H1V14.6667H11V9.16667H15V14.6667H17V9.16667H18ZM9 12.8333H3V9.16667H9V12.8333Z" fill="white"/>
                        </svg>
                    ...
                    <NavLink to="/library" activeClassName="active" className={`nav-btn`}>
                        ...
                        <svg width="20" height="20" className="inline" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2 4H0V18C0 19.1 0.9 20 2 20H16V18H2V4ZM18 0H6C4.9 0 4 0.9 4 2V14C4 15.1 4.9 16 6 16H18C19.1 16 20 15.1 20 14V2C20 0.9 19.1 0 18 0ZM17 9H7V7H17V9ZM13 13H7V11H13V13ZM17 5H7V3H17V5Z" fill="white"/>
                        </svg>

                            
                        <span className="inline-block pl-4">Library</span>
                            
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 inline float-right" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <NavLink to="/analytics" activeClassName="active" className={`nav-btn`}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <NavLink to="/settings" activeClassName="active" className={`nav-btn`}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <NavLink to="/notification" activeClassName="active" className={`nav-btn active rounded-30 px-6 py-5 shadow-all`}>
                        <div className="shadow-all rounded-15 p-2 text-white">
                            ...
                            <p className="leading-4 text-darkPurple-200 truncate">Latest notification text goes here.</p>
                        </div>
                    </NavLink>
